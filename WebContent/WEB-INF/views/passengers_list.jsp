...
<body>
	...
	<table>
		...
		<%
			...
			List<Passenger> pList = (List<Passenger>) request.getAttribute("passengersList");
		 ...
		 %>
		 	...
		 	<tr>
		 		<td colspan="5">
		 			<%
		 				if(pList.get(i).getFlightsList().size() > 0) {
		 					
		 					List<Flight> fList = (List<Flight>) pList.get(i).getFlightsList();
